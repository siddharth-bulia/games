...
Game.endLevel = function() {
	Popup.alert('Level ' + Game.level + ' upgrade !', Game.nextLevel);
	Game.removeHint();
}
...
Game.gameOver = function() {
	Popup.confirm('There are no more movements possible.<br/>Would you like to start over ?', null, Game.restart);
	Game.paused = true;
};