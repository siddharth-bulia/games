class Board{
	...
	arrangeGattis(ctx){
		...
		var r = this.gattis[0].radius;

		var sin45 = s*Math.sin(Math.PI/3);
		var cos45 = s*Math.cos(Math.PI/3);

		var w = canvas.width/2;
		var h = canvas.height/2;

		// first circle of gattis
		this.gattis.push(new Gatti("black", new Point(canvas.width/2 + sin45,canvas.height/2 + cos45)));
		this.gattis.push(new Gatti("white", new Point(canvas.width/2,canvas.height/2 + s)));

		this.gattis.push(new Gatti("black", new Point(canvas.width/2 - sin45,canvas.height/2 + cos45)));
		this.gattis.push(new Gatti("white", new Point(canvas.width/2 - sin45,canvas.height/2 - cos45)));

		this.gattis.push(new Gatti("black", new Point(canvas.width/2,canvas.height/2 - s)));
		this.gattis.push(new Gatti("white", new Point(canvas.width/2 + sin45,canvas.height/2 - cos45)));

		// second circle of gattis
		this.gattis.push(new Gatti("white", new Point(canvas.width/2,canvas.height/2 - 2*s)));
		this.gattis.push(new Gatti("black", new Point(canvas.width/2 + sin45,canvas.height/2 + 1.5*s)));
		...
		this.gattis.push(new Gatti("black", new Point(canvas.width/2 + 2*s,canvas.height/2)));
		this.gattis.push(new Gatti("black", new Point(canvas.width/2 - 2*s,canvas.height/2)));

		this.gattis.push(new Gatti("white", new Point(canvas.width/2 + 2*sin45,canvas.height/2 - 2*cos45)));
		this.gattis.push(new Gatti("white", new Point(canvas.width/2 - 2*sin45,canvas.height/2 - 2*cos45)));

		this.gattis.push(new Gatti("white", new Point(canvas.width/2 - 2*sin45,canvas.height/2 + 2*cos45)));
		this.gattis.push(new Gatti("white", new Point(canvas.width/2 + 2*sin45,canvas.height/2 + 2*cos45)));

		// this.gattis.push(new Gatti("black", new Point(canvas.width/2,canvas.height/2 + cos45)));
		// this.gattis.push(new Gatti("white", new Point(canvas.width/2,canvas.height/2 + 2*cos45)));

		// this.gattis.push(new Gatti("black", new Point(canvas.width/2 + sin45,canvas.height/2 + s)));
		// this.gattis.push(new Gatti("white", new Point(canvas.width/2 + 2*sin45,canvas.height/2 + 2*cos45)));
