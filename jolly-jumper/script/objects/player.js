var player = function(game){
    ...
    player.prototype = {
        ...
        create: function(){ 
            ...
            var buttonContainer = document.getElementById("buttonContaner");
            var leftButton = buttonContainer.children[0];
            var rightButton = buttonContainer.children[1];
            var jumpButton = buttonContainer.children[2];

            var gameControl = this;
            leftButton.ontouchstart = function (e) {
                gameControl.cursor.left.isDown = true;
            };

            leftButton.ontouchend = function (e) {
                gameControl.cursor.left.isDown = false;
            };

            rightButton.ontouchstart = function (e) {
                gameControl.cursor.right.isDown = true;
            };

            rightButton.ontouchend = function (e) {
                gameControl.cursor.right.isDown = false;
            };

            jumpButton.ontouchstart = function(e) {
                gameControl.jumpButton.isDown = true;
            };

            jumpButton.ontouchstart = function(e) {
                gameControl.jumpButton.isDown = false;
            };
